...
SECRET_KEY = 'django-insecure-8e5l-8n$4s-h)bp*52n%#cxg@@u95l=mq4p5ynuo-lk_yf&rhv'
...
WSGI_APPLICATION = 'Green_Gauge.wsgi.application'
...
CORS_ALLOW_ALL_ORIGINS = False  # Ensure this is False in production for security
